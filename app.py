...
ALLOWED_GUILD_FIELDS = {
    ...
    "welcome_color", "welcome_image", "welcome_footer",
    "farewell_enabled", "farewell_channel", "farewell_title", "farewell_message",
    "farewell_color", "farewell_image", "farewell_footer",
    ...
    "automod_spam_count", "automod_spam_window", "automod_punishment",
    "automod_link_whitelist",
    "economy_starting_koins", "economy_daily_min", "economy_daily_max",
    "economy_work_cooldown", "economy_rob_cooldown", "economy_daily_streak_bonus",
    "economy_rob_chance", "economy_crime_chance", "economy_heist_chance",
